...
class _AnimatedColorTextState extends AnimatedWidgetBaseState<AnimatedColorText> {
  ...
  Widget build(BuildContext context) {
    return Text(widget.text, style: TextStyle(color: _colorTween.evaluate(animation)),);
  }

  @override
  void forEachTween(visitor) {
    _colorTween = visitor(_colorTween, widget.textColor, (dynamic value) => ColorTween(begin: value));
  }
}
